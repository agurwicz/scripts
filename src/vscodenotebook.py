...
class VscodeNotebook(BaseScript):

    @property
    def _description(self):
        return 'Creates empty Jupyter Notebook in $PWD and opens in Visual Studio Code.'
    ...
    def run(self):
        ...
        self.run_command(command=self._variables.vscode_path, parameters=notebook_path)
